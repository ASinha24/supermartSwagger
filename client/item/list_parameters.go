...
// WithItems adds the items to the list params
func (o *ListParams) WithItems(items *string) *ListParams {
	o.SetItems(items)
	return o
}

// SetItems adds the items to the list params
func (o *ListParams) SetItems(items *string) {
	o.Items = items
}
...
func (o *ListParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.Items != nil {
		...
		qItems := qrItems
		if qItems != "" {
			if err := r.SetQueryParam("items", qItems); err != nil {
				return err
			}
		}

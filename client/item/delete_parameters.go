...
// WithItemID adds the itemID to the delete params
func (o *DeleteParams) WithItemID(itemID string) *DeleteParams {
	o.SetItemID(itemID)
	return o
}

// SetItemID adds the itemId to the delete params
func (o *DeleteParams) SetItemID(itemID string) {
	o.ItemID = itemID
}

...
// WithItem adds the item to the create params
func (o *CreateParams) WithItem(item *models.Item) *CreateParams {
	o.SetItem(item)
	return o
}

// SetItem adds the item to the create params
func (o *CreateParams) SetItem(item *models.Item) {
	o.Item = item
}

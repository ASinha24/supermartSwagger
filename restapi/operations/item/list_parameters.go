...
func (o *ListParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	qItems, qhkItems, _ := qs.GetOK("items")
	if err := o.bindItems(qItems, qhkItems, route.Formats); err != nil {
		res = append(res, err)
	}
...
// bindItems binds and validates parameter Items from query.
func (o *ListParams) bindItems(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
